...
SHOP_CATALOG = (
    ...
    {"id": "gadget-smart-ring", "name": "Голографическое кольцо", "description": "Миниатюрный интерфейс с сияющим индикатором.", "price": 2500, "department": "laptop", "slot": "accessory", "icon": "💍"},
